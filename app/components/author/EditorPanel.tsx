...
import { useAuthorMode, isLegacyContentType } from './DevModeProvider';
import { FrontmatterEditor } from './FrontmatterEditor';
import { MarkdownEditor } from './MarkdownEditor';

// Legacy content types that EditorPanel handles
type LegacyContentType = 'post' | 'about' | 'experience' | 'home';
...
export function EditorPanel() {
  ...
  // Only handle legacy content types (file-based markdown editing)
  // View system content types (markdown, component, view) are handled elsewhere
  if (!editingContent || !isLegacyContentType(editingContent.type)) return null;

  // Type narrowing - we know it's a legacy type now
  const contentType = editingContent.type as LegacyContentType;
