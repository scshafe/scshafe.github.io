...
export default function Footer() {
  ...
  views.forEach((view) => {
    viewPathMap.set(view.id, view.path);
  });
  ...
  const defaultNavItems: NavItem[] = [
    { id: 9000000001, label: 'RSS Feed', linkType: 'url', url: '/feed.xml', icon: 'rss', external: false },
    { id: 9000000002, label: 'GitHub', linkType: 'url', url: 'https://github.com/scshafe', icon: 'github', external: true },
  ];
