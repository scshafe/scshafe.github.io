...
export default function Header() {
  ...
  // Create a map of view IDs to paths for quick lookup
  ...
  const getNavItemUrl = useCallback((item: NavItem): string => {
  ...
  const defaultNavItems: NavItem[] = [
    { id: 9000000003, label: 'Blog', linkType: 'url', url: '/blog/', position: 'right', external: false },
    { id: 9000000004, label: 'About', linkType: 'url', url: '/about/', position: 'right', external: false },
    { id: 9000000005, label: 'GitHub', linkType: 'url', url: 'https://github.com/scshafe', position: 'right', icon: 'external', external: true },
  ];
