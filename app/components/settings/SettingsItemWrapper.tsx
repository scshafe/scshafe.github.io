...
export function SettingsItemWrapper({
  label,
  children,
  isFirst = false,
  isLast = false,
  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragOver ? 'ring-2 ring-[var(--link)]' : ''}
      `}
      ...
      {isHovered && (
        <div className="absolute -top-8 left-0 right-0 flex items-center justify-between z-10">
          ...
          <div className="flex items-center gap-1 bg-[var(--background-secondary)] border border-[var(--border)] rounded-md px-1 py-0.5">
            ...
            {(onMoveUp || onMoveDown || draggable) && <div className="w-px h-4 bg-[var(--border)] mx-0.5" />}
