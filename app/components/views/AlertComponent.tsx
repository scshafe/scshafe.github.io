...
import type { AlertComponent as AlertConfig } from '@/lib/content/views';
...
export function AlertComponent({ config }: AlertComponentProps) {
  ...
  return (
    ...
    >
      ...
      <p className="flex-1 text-[var(--foreground)]">{config.content}</p>
      {config.dismissible && (
        <button
