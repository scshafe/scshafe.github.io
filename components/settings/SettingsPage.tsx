...
type TabId = 'general' | 'views' | 'navigation' | 'theme';
...
export function SettingsPage({ initialNavConfig, initialThemeConfig, initialViews, initialSiteConfig }: SettingsPageProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="pb-12">
        {activeTab === 'general' && (
          <GeneralTab initialConfig={initialSiteConfig} />
        )}
        {activeTab === 'views' && (
          <ViewsTab initialViews={initialViews} />
        )}
